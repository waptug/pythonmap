...
# Add state and territory capitals to the map
data = {
    # Data for all states and territories, capitals, coordinates, and websites
    # Complete this dictionary with the rest of the data
    ...
    'Website': ['http://www.alabama.gov', 'http://alaska.gov', 'https://az.gov', 'https://portal.arkansas.gov/',
...
for idx, (state, capital, lat, lon, website) in enumerate(zip(data['State'], data['Capital'], data['Latitude'], data['Longitude'], data['Website'])):
    ...
    L.marker([{lat}, {lon}]).addTo(this.map)
      .bindPopup('<a href="{website}" target="_blank">{state}</a>');
    """
